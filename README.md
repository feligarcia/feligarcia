...
### StocksApp - Sistema de Análisis Bursátil 📈 :new: :star:

Aplicación completa para análisis de mercados financieros con backend en Go y frontend en Vue 3, conectada a CockroachDB.

#### 🖥️ Backend (Go Fiber + CockroachDB)
- **Arquitectura**: API REST con Go Fiber  
- **Base de Datos**: PostgreSQL/CockroachDB con pgx como driver  
...
-  Búsqueda inteligente de tickers
-  Diseño responsive
